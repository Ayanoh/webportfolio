  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      ...
      >
        <textarea
          className={cn(
            `flex min-h-20 h-28 w-full bg-white dark:bg-zinc-800 text-black dark:text-white shadow-input rounded-md px-3 py-2 text-sm
          ...
          focus-visible:outline-none focus-visible:ring-[2px] focus-visible:ring-brand dark:focus-visible:ring-brand
           ...
           shadow-sm dark:shadow-[0px_0px_1px_1px_var(--neutral-700)]
